    ...
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
        ...
        <div class="flex-grow">
          ...
          <p class=" text-base">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus amet quo dicta id nemo recusandae tempore ex est aperiam dignissimos neque a doloremque facere reprehenderit, tenetur dolores nostrum? Cupiditate, harum?.</p>

        </div>
      </div>
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
        <div class="w-20 h-20 inline-flex items-center justify-center rounded-full text-red-500  mb-5 flex-shrink-0">
        <img src={code} alt="" />
        </div>
        <div class="flex-grow">
          <h2 class="text-white text-lg  font-medium mb-3">Development</h2>
