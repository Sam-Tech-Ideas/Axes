...
<div className="lg:flex-grow md:w-1/2  flex flex-col md:items-start md:text-left  md:mb-0 items-center text-center">
      ...
      <p className="mb-8 ">AXES Technologies is  a digital firm that offers several services such as Web and App Development, Mentoring and Training  to Developers, we <br /> tacos poke beard tote bag. Heirloom ech tumeric truffaut hexagon try-hard chambray.</p>
  ...
  <div class=" py-24 ">
    <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start text-center">
       ...
       <p class="pl-3 flex-shrink-0 text-white  border-0 py-2 px-8 flex   text-lg mt-10 sm:mt-0 justify-center">We provide you the opportunity to interact with top professionals around the globe.</p>
    </div>
  </div>
</section>
